...
<p style="color: purple">{{ session('updatemessage') }}</p>
<hr>
@endif
...
<form class="box" method="POST" action="/blogs/{{ $blog->id }}/comments/">
    ...
    <div class="field">
        ...
        <div class="control">
            <input type="text" class="input {{ $errors->has('subject') ? 'is-danger' : '' }}" name="subject"
...
<p style="color: purple">{{ session('updatecomment') }}</p>
<br>
@endif
